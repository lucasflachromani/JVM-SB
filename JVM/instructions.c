...
void funct_athrow() { frameAtual->pc++;  } /* Näo precisa fazer nada além disso */
...
void funct_monitorenter() { pop(); frameAtual->pc++;  } /* só precisa disso */

void funct_monitorexit() { pop(); frameAtual->pc++;  } /* só precisa disso */
