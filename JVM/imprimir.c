...
void populate_opcode_info() {
	...
	strcpy(op_informacao[0xbf].descricao, "athrow");
	...
	strcpy(op_informacao[0xc0].descricao, "checkcast");
	...
	strcpy(op_informacao[0x59].descricao, "dup");
	strcpy(op_informacao[0x5a].descricao, "dup_x1");
	strcpy(op_informacao[0x5b].descricao, "dup_x2");
	strcpy(op_informacao[0x5c].descricao, "dup2");
	strcpy(op_informacao[0x5d].descricao, "dup2_x1");
	strcpy(op_informacao[0x5e].descricao, "dup2_x2");
	...
	strcpy(op_informacao[0x30].descricao, "faload");
	...
	strcpy(op_informacao[0xc1].descricao, "instanceof");
	...
	strcpy(op_informacao[0xc2].descricao, "monitorenter");
	strcpy(op_informacao[0xc3].descricao, "monitorexit");
	...
	strcpy(op_informacao[0x57].descricao, "pop");
	strcpy(op_informacao[0x58].descricao, "pop2");
	...
	strcpy(op_informacao[0x5f].descricao, "swap");
	strcpy(op_informacao[0xaa].descricao, "tableswitch");
	strcpy(op_informacao[0xc4].descricao, "wide");
	strcpy(op_informacao[0xca].descricao, "breakpoint");
	strcpy(op_informacao[0xfe].descricao, "impdep1");
	strcpy(op_informacao[0xff].descricao, "impdep2");
	strcpy(op_informacao[0xba].descricao, "xxxunusedxxx");

	for (i = 0xcb; i < 0xfe; i++) {
		strcpy(op_informacao[i].descricao, "(no name)");
	}


	op_informacao[0x32].operandos_count = 0;
	op_informacao[0x53].operandos_count = 0;
	op_informacao[0x01].operandos_count = 0;
	op_informacao[0x19].operandos_count = 1;
	op_informacao[0x2a].operandos_count = 0;
	op_informacao[0x2b].operandos_count = 0;
	op_informacao[0x2c].operandos_count = 0;
	op_informacao[0x2d].operandos_count = 0;
	op_informacao[0xbd].operandos_count = 2;
	op_informacao[0xb0].operandos_count = 0;
	op_informacao[0xbe].operandos_count = 0;
	op_informacao[0x3a].operandos_count = 1;
	op_informacao[0x4b].operandos_count = 0;
	op_informacao[0x4c].operandos_count = 0;
	op_informacao[0x4d].operandos_count = 0;
	op_informacao[0x4e].operandos_count = 0;
	op_informacao[0xbf].operandos_count = 0;
	op_informacao[0x33].operandos_count = 0;
	op_informacao[0x54].operandos_count = 0;
	op_informacao[0x10].operandos_count = 1;
	op_informacao[0x34].operandos_count = 0;
	op_informacao[0x55].operandos_count = 0;
	op_informacao[0xc0].operandos_count = 2;
	op_informacao[0x90].operandos_count = 0;
	op_informacao[0x8e].operandos_count = 0;
	op_informacao[0x8f].operandos_count = 0;
	op_informacao[0x63].operandos_count = 0;
	op_informacao[0x31].operandos_count = 0;
	op_informacao[0x52].operandos_count = 0;
	op_informacao[0x98].operandos_count = 0;
	op_informacao[0x97].operandos_count = 0;
	op_informacao[0x0e].operandos_count = 0;
	op_informacao[0x0f].operandos_count = 0;
	op_informacao[0x6f].operandos_count = 0;
	op_informacao[0x18].operandos_count = 1;
	op_informacao[0x26].operandos_count = 0;
	op_informacao[0x27].operandos_count = 0;
	op_informacao[0x28].operandos_count = 0;
	op_informacao[0x29].operandos_count = 0;
	op_informacao[0x6b].operandos_count = 0;
	op_informacao[0x77].operandos_count = 0;
	op_informacao[0x73].operandos_count = 0;
	op_informacao[0xaf].operandos_count = 0;
	op_informacao[0x39].operandos_count = 1;
	op_informacao[0x47].operandos_count = 0;
	op_informacao[0x48].operandos_count = 0;
	op_informacao[0x49].operandos_count = 0;
	op_informacao[0x4a].operandos_count = 0;
	op_informacao[0x67].operandos_count = 0;
	op_informacao[0x59].operandos_count = 0;
	op_informacao[0x5a].operandos_count = 0;
	op_informacao[0x5b].operandos_count = 0;
	op_informacao[0x5c].operandos_count = 0;
	op_informacao[0x5d].operandos_count = 0;
	op_informacao[0x5e].operandos_count = 0;
	op_informacao[0x8d].operandos_count = 0;
	op_informacao[0x8b].operandos_count = 0;
	op_informacao[0x8c].operandos_count = 0;
	op_informacao[0x62].operandos_count = 0;
	op_informacao[0x30].operandos_count = 0;
	op_informacao[0x51].operandos_count = 0;
	op_informacao[0x96].operandos_count = 0;
	op_informacao[0x95].operandos_count = 0;
	op_informacao[0x0b].operandos_count = 0;
	op_informacao[0x0c].operandos_count = 0;
	op_informacao[0x0d].operandos_count = 0;
	op_informacao[0x6e].operandos_count = 0;
	op_informacao[0x17].operandos_count = 1;
	op_informacao[0x22].operandos_count = 0;
	op_informacao[0x23].operandos_count = 0;
	op_informacao[0x24].operandos_count = 0;
	op_informacao[0x25].operandos_count = 0;
	op_informacao[0x6a].operandos_count = 0;
	op_informacao[0x76].operandos_count = 0;
	op_informacao[0x72].operandos_count = 0;
	op_informacao[0xae].operandos_count = 0;
	op_informacao[0x38].operandos_count = 1;
	op_informacao[0x43].operandos_count = 0;
	op_informacao[0x44].operandos_count = 0;
	op_informacao[0x45].operandos_count = 0;
	op_informacao[0x46].operandos_count = 0;
	op_informacao[0x66].operandos_count = 0;
	...
	op_informacao[0x91].operandos_count = 0;
	op_informacao[0x92].operandos_count = 0;
	op_informacao[0x87].operandos_count = 0;
	op_informacao[0x86].operandos_count = 0;
	op_informacao[0x85].operandos_count = 0;
	op_informacao[0x93].operandos_count = 0;
	op_informacao[0x60].operandos_count = 0;
	op_informacao[0x2e].operandos_count = 0;
	op_informacao[0x7e].operandos_count = 0;
	op_informacao[0x4f].operandos_count = 0;
	op_informacao[0x02].operandos_count = 0;
	op_informacao[0x03].operandos_count = 0;
	op_informacao[0x04].operandos_count = 0;
	op_informacao[0x05].operandos_count = 0;
	op_informacao[0x06].operandos_count = 0;
	op_informacao[0x07].operandos_count = 0;
	op_informacao[0x08].operandos_count = 0;
	op_informacao[0x6c].operandos_count = 0;
	...
	op_informacao[0x1a].operandos_count = 0;
	op_informacao[0x1b].operandos_count = 0;
	op_informacao[0x1c].operandos_count = 0;
	op_informacao[0x1d].operandos_count = 0;
	op_informacao[0x68].operandos_count = 0;
	op_informacao[0x74].operandos_count = 0;
	op_informacao[0xc1].operandos_count = 2;
	...
	op_informacao[0x80].operandos_count = 0;
	op_informacao[0x70].operandos_count = 0;
	op_informacao[0xac].operandos_count = 0;
	op_informacao[0x78].operandos_count = 0;
	op_informacao[0x7a].operandos_count = 0;
	op_informacao[0x36].operandos_count = 1;
	op_informacao[0x3b].operandos_count = 0;
	op_informacao[0x3c].operandos_count = 0;
	op_informacao[0x3d].operandos_count = 0;
	op_informacao[0x3e].operandos_count = 0;
	op_informacao[0x64].operandos_count = 0;
	op_informacao[0x7c].operandos_count = 0;
	op_informacao[0x82].operandos_count = 0;
	op_informacao[0xa8].operandos_count = 2;
	op_informacao[0xc9].operandos_count = 4;
	op_informacao[0x8a].operandos_count = 0;
	op_informacao[0x89].operandos_count = 0;
	op_informacao[0x88].operandos_count = 0;
	op_informacao[0x61].operandos_count = 0;
	op_informacao[0x2f].operandos_count = 0;
	op_informacao[0x7f].operandos_count = 0;
	op_informacao[0x50].operandos_count = 0;
	op_informacao[0x94].operandos_count = 0;
	op_informacao[0x09].operandos_count = 0;
	op_informacao[0x0a].operandos_count = 0;
	op_informacao[0x12].operandos_count = 1;
	op_informacao[0x13].operandos_count = 2;
	op_informacao[0x14].operandos_count = 2;
	op_informacao[0x6d].operandos_count = 0;
	op_informacao[0x16].operandos_count = 1;
	op_informacao[0x1e].operandos_count = 0;
	op_informacao[0x1f].operandos_count = 0;
	op_informacao[0x20].operandos_count = 0;
	op_informacao[0x21].operandos_count = 0;
	op_informacao[0x69].operandos_count = 0;
	op_informacao[0x75].operandos_count = 0;
	op_informacao[0xab].operandos_count = 10; /*TODO Ver se realmente ṣo 10 operandos */
	op_informacao[0x81].operandos_count = 0;
	op_informacao[0x71].operandos_count = 0;
	op_informacao[0xad].operandos_count = 0;
	op_informacao[0x79].operandos_count = 0;
	op_informacao[0x7b].operandos_count = 0;
	op_informacao[0x37].operandos_count = 1;
	op_informacao[0x3f].operandos_count = 0;
	op_informacao[0x40].operandos_count = 0;
	op_informacao[0x41].operandos_count = 0;
	op_informacao[0x42].operandos_count = 0;
	op_informacao[0x65].operandos_count = 0;
	op_informacao[0x7d].operandos_count = 0;
	op_informacao[0x83].operandos_count = 0;
	op_informacao[0xc2].operandos_count = 0;
	op_informacao[0xc3].operandos_count = 0;
	op_informacao[0xc5].operandos_count = 3;
	op_informacao[0xbb].operandos_count = 2;
	op_informacao[0xbc].operandos_count = 1;
	op_informacao[0x00].operandos_count = 0;
	op_informacao[0x57].operandos_count = 0;
	op_informacao[0x58].operandos_count = 0;
	op_informacao[0xb5].operandos_count = 2;
	op_informacao[0xb3].operandos_count = 2;
	op_informacao[0xa9].operandos_count = 1;
	op_informacao[0xb1].operandos_count = 0;
	op_informacao[0x35].operandos_count = 0;
	op_informacao[0x56].operandos_count = 0;
	op_informacao[0x11].operandos_count = 2;
	op_informacao[0x5f].operandos_count = 0;
	...
	op_informacao[0xca].operandos_count = 0;
	op_informacao[0xfe].operandos_count = 0;
	op_informacao[0xff].operandos_count = 0;
	op_informacao[0xba].operandos_count = 0;
